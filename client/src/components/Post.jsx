import { Heart, Bookmark, MessageSquareText, Share2 } from "lucide-react";
...
const Post = ({ post }) => {
    ...
    return (
        <article className="post-card bg-white p-6 rounded-xl transition-all mb-2 shadow-xs">
            <div className="flex gap-4">
                ...
                <div className="flex-1">
                    ...
                    {/* <div className="rounded-xl overflow-hidden mb-4 border border-secondary">
                        <img
                            alt="Brain Scan"
